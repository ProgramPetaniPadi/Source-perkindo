                    ...
                    <div class="card card-details">
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                                ...
                                <label class="sr-only" for="nationality" name=nationality">Nationality</label>
                                <input type="text" class="form-control mb-2 mr-sm-2" style="width: 50px;" name="nationality" id="nationality" required placeholder="Nationality" />
