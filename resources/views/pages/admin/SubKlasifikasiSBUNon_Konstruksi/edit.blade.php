...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Data Sub_Klasifikasi_SBU_Non_Konstruksi
            {{ $item->klasifikasi_sbu_non_konstruksi_id }}
        </h1>
    </div>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('SubKlasifikasiSBUNon_Konstruksi.update', $item->id) }}" method="POST">
                @method('PUT')
                @csrf

                <div class="form-group">
                    <label for="klasifikasi_sbu_non_konstruksi_id ">JABATAN</label>
